# AGILE : Rendu final (mercredi 15/11)
...
![](files/uml/states.png)

## Diagramme de classes et packages

![](files/graphviz/packages.png)
![](files/class_package_diagrams/iter3.png)
...
![](files/planning/planning-iteration_1.jpg)

### 2e itération (du 25/10 au 08/11)

![](files/planning/planning-iteration_2.jpg)

### 3e itération (du 09/11 au 13/11)

![](files/planning/planning-iteration_3.jpg)
